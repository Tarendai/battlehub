...
public class CPlayerTablePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(36, 36, 36)
                .addComponent(UserSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
    ...
    private void UserTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UserTableMousePressed
        if (evt.getClickCount() > 1) {
            ...
            CPlayer cp = LMain.playermanager.GetPlayer(n);
            if(cp == null){
                return;
            }
            
            org.darkstars.battlehub.gui.CPlayerDataWindow p = new CPlayerDataWindow(LM, cp);
            p.setVisible(true);
        }
