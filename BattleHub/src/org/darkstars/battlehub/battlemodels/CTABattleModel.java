...
class CTATask extends Thread {

    public CTABattleModel b;
    

    CTATask(CTABattleModel battle) {
        b = battle;
    }
    ...
    public void run() {
        ...
        try {
            //b.ingame = true;
            String sp = CUserSettings.GetValue("ta.command", "totala ");
            if(b.AmIHost()){
                ...
                String h = b.GetInfo().GetDescription();
 ...
 * @author tarendai
 */
public class CTABattleModel extends CBaseModule implements IBattleModel {

    private CBattleInfo info = null;
    private CBasicBattleWindow battlewindow = null;
    private boolean ingame = false;
    
    public CTABattleModel(){
